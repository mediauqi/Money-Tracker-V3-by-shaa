...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-rose-400 via-pink-400 to-fuchsia-500 dark:from-rose-900 dark:via-pink-900 dark:to-fuchsia-900">
        ...
        <div className="backdrop-blur-2xl bg-white/20 dark:bg-black/20 border border-white/30 dark:border-white/10 rounded-3xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-rose-400 to-pink-500 rounded-2xl mb-4 shadow-xl"
            >
