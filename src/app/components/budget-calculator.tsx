...
export function BudgetCalculator({ onClose }: Props) {
  ...
  return (
    <div className="h-full overflow-y-auto">
      <Card className="h-full min-h-screen sm:min-h-0 sm:max-h-[calc(100vh-120px)] overflow-y-auto p-4 sm:p-6 backdrop-blur-xl bg-white/90 dark:bg-black/90 border-white/50 dark:border-white/10 shadow-2xl sm:rounded-2xl rounded-none">
        {/* Header */}
