...
import { LogOut, Sun, Moon, TrendingUp, TrendingDown, Wallet, Calculator, User, Plus, Trash2 } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-rose-400 to-pink-500 rounded-xl sm:rounded-2xl text-2xl sm:text-3xl hover:scale-105 transition-transform shadow-lg"
              >
                {user?.emoji}
              </button>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {/* Calculator button - same icon for mobile and desktop */}
              <Button
                variant="ghost"
                size="icon"
