          ...
          <Card className="p-6 sm:p-8 backdrop-blur-xl bg-gradient-to-br from-white/60 to-purple-100/40 dark:from-black/40 dark:to-purple-900/20 border-white/50 dark:border-white/10 shadow-2xl text-center">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="relative">
                <div className="flex items-center justify-center w-28 h-28 sm:w-32 sm:h-32 bg-gradient-to-br from-yellow-300 to-orange-400 rounded-3xl text-6xl sm:text-7xl shadow-2xl mb-4">
                  {user?.emoji}
                </div>
                <Button
                  size="icon"
